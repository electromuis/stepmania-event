...
return Def.ActorFrame{
	InitCommmand=function(self)
		self:xy(_screen.w*1.7,_screen.cy)
	end,	
	...
	Def.Quad{
		Name="BackgroundQuad",
		InitCommand=cmd(zoomto,  _screen.w/5.6, _screen.h/28; x, _screen.w*0.1245; diffuse, DifficultyIndexColor(1) ),
