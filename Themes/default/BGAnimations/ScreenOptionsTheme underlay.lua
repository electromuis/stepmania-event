local t = Def.ActorFrame{
	Def.Quad{
		Name="TopLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*0.6;addy,-SCREEN_CENTER_Y;zoomto,SCREEN_WIDTH,2;diffuseleftedge,HSV(192,1,0.8););
	...
	Def.Quad{
		Name="BottomLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*1.25;addy,SCREEN_CENTER_Y;zoomto,SCREEN_WIDTH,2;diffuserightedge,HSV(192,1,0.8););
		OnCommand=cmd(linear,0.3;addy,-SCREEN_CENTER_Y);
		OffCommand=cmd(linear,0.3;addy,SCREEN_CENTER_Y);
