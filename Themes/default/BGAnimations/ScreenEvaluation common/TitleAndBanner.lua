...
return Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=cmd(diffuse,color("#1E282F"); xy,_screen.cx, 15.5; zoomto, 292.5,20),
	},

	-- song/course title text
	LoadFont("_miso")..{
		InitCommand=cmd(xy,_screen.cx,15; maxwidth, 294 ),
	...
	LoadActor( THEME:GetPathB("ScreenSelectMusic", "overlay/colored_banners/".. banner_directory .."/banner" .. SL.Global.ActiveColorIndex .. " (doubleres).png"))..{
		OnCommand=cmd(xy, _screen.cx, 82; zoom, 0.7)
	},
	...
	Def.Banner{
		...
		OnCommand=cmd(xy, _screen.cx, 82; setsize,418,164; zoom, 0.7 )
	}
}