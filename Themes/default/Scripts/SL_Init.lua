...
SL = {
	...
	P3 = setmetatable( {}, PlayerDefaults),
	P4 = setmetatable( {}, PlayerDefaults),
	P5 = setmetatable( {}, PlayerDefaults),
	P6 = setmetatable( {}, PlayerDefaults),
	P7 = setmetatable( {}, PlayerDefaults),
	P8 = setmetatable( {}, PlayerDefaults),
